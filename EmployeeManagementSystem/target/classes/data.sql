...
insert into employee (id, first_name, last_name, email) values (1, 'virat', 'kholi', 'abc@gmail.com');
insert into employee (id, first_name, last_name, email) values (2, 'rohit', 'sharma', 'xyz@gmail.com');
insert into employee (id, first_name, last_name, email) values (3, 'ishan', 'khan', 'pql@gmail.com');
